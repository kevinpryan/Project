...
# gtex.psam - GTEx sample info, dorothea_hs_with_target_info.txt, fractional rank data. Change file paths as necessary.
...
# args[2] - frac_rank or whole_blood_norm (whole_blood_tpm deprecated)
# args[3] - pass - used to be an option to extract subject ids from sample ids, deprecated
# args[4] - all_covariates, reduced_covariates or no_covariates
# args[5] - filtered_tf or no_filter_tf
# Edit line 265 and/or 596 to write to file of interest 
# Load in packages
library(stringr)
library(biomaRt)
library(vroom)
